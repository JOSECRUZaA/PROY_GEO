...
DROP POLICY IF EXISTS "Permitir insert a todos" ON proveedores;
CREATE POLICY "Permitir insert a todos" ON proveedores FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Permitir update a todos" ON proveedores;
CREATE POLICY "Permitir update a todos" ON proveedores FOR UPDATE USING (true) WITH CHECK (true);
DROP POLICY IF EXISTS "Permitir delete a todos" ON proveedores;
CREATE POLICY "Permitir delete a todos" ON proveedores FOR DELETE USING (true);
